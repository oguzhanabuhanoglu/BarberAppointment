//
//  BarberVerificationViewController.swift
//  ErsinBerber
//
...
class BarberVerificationViewController: UIViewController, UITextFieldDelegate {
    ...
    @objc func didTapVerifyButton() {
        ...
        guard let barber = barber else {
            return
        }
        
        AuthManager.shared.verifyBarber(barber: barber, verificationCode: verificationCode) { result in
            switch result {
